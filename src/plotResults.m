...
#
# Plots PI results as plots and save it in *.pdf
# 
...
annotation(figure_handle,'textbox',[0.00625 0.75 0.0963541666666667 0.172377985462097],...
     ...
     ['Height: ' num2str(personal_data.subject_height) ' cm'],...
...
for j = 1:length(fieldNames)
    ...
    subplot(4,6,j+1+18)
    hold on
    target_error_mean = [nanmean(plot_pert_data.l_step.target_error) nanmean(plot_pert_data.r_step.target_error)];
    target_error_std = [nanstd(plot_pert_data.l_step.target_error) nanstd(plot_pert_data.r_step.target_error)];
