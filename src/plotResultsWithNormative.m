function plotResultsWithNormative(filename, subject_info, condition, sorted_data, normative)
################################################################################
# 'plotResultsWithNormative(filename, subject_info, condition, sorted_data, normative)'
# 
...
annotation(figure_handle,'textbox',[0.00625 0.75 0.09 0.17],...
     'String',{...
     ['Subject ID: ' num2str(subject_info.subject_ID)],'',...
     ['Age: ' num2str(subject_info.subject_age) ' yrs'],...
     ['Height: ' num2str(subject_info.subject_height) ' m'],...
     ['Mass: ' num2str(subject_info.subject_mass) ' kg'],...
     ['Gender: ' subject_info.subject_gender],...
     ['Affected side: ' subject_info.subject_affected_body_side],...
     ['Treadmill speed: ' num2str(condition.treadmill_speed) ' m/s'],...
     ['Pert. amplitude: ' num2str(condition.perturbation_amplitude) ' m']},...
     'FitBoxToText','on');
